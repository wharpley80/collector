        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="btn-group region-menu" role="group" aria-label="Basic example">
                    <a type="button" class="all-regions btn btn-secondary" href="http://collector.test/platform/{{ $platform[0]['id'] }}">All</a>
                    <a type="button" class="na-regions btn btn-secondary" href="http://collector.test/platform/{{ $platform[0]['id'] }}/north_america">NA</a>
                    <a type="button" class="jp-regions btn btn-secondary" href="http://collector.test/platform/{{ $platform[0]['id'] }}/japan">JP</a>
                    <a type="button" class="pal-regions btn btn-secondary" href="http://collector.test/platform/{{ $platform[0]['id'] }}/europe">PAL</a>
                </div>
                <div class="card-body">
                    <game-list-component v-bind:games="{{ json_encode($games) }}"></game-list-component>
                    <div class="pagination-cont">
                        <div class="pagination"> 
                            <a href="http://collector.test/platform/{{ $platform[0]['id'] }}/{{ $region }}/page=" class="paginate-prev">«</a> 
                            <a href="http://collector.test/platform/{{ $platform[0]['id'] }}/{{ $region }}/page=1" class="paginate-1 active">1</a> 
                            <a href="http://collector.test/platform/{{ $platform[0]['id'] }}/{{ $region }}/page=2" class="paginate-2">2</a> 
                            <a href="http://collector.test/platform/{{ $platform[0]['id'] }}/{{ $region }}/page=3" class="paginate-3">3</a> 
                            <a href="http://collector.test/platform/{{ $platform[0]['id'] }}/{{ $region }}/page=4" class="paginate-4">4</a> 
                            <a href="http://collector.test/platform/{{ $platform[0]['id'] }}/{{ $region }}/page=5" class="paginate-5">5</a> 
                            <a href="http://collector.test/platform/{{ $platform[0]['id'] }}/{{ $region }}/page=" class="paginate-next">»</a> 
                        </div>
                    </div>
                </div>
            </div>
